...
> FL1623863129 于 2025-06-07 09:58:28 发布 阅读量899 收藏 11 点赞数 25 公开
> 文章链接：https://blog.csdn.net/FL1623863129/article/details/148491408
...
​ <img src="./assets/64_1.png" alt="" style="max-height:454px; box-sizing:content-box;" />
...
<img src="./assets/64_2.png" alt="" style="max-height:306px; box-sizing:content-box;" />
...
- 支持的任务范围广泛：无论是对象检测、实例分割、图像分类、姿态估计还是定向对象检测 (OBB)，YOLO11 旨在应对各种计算机视觉挑战。
 ...
 <img src="./assets/64_3.png" alt="" style="max-height:270px; box-sizing:content-box;" />
...
##### 1. 新增AodPONONet.py实现模块（代码太多，核心模块源码请参考改进步骤.docx）然后在同级目录下面创建一个__init___.py文件写代码
...
    model = YOLO('yolo11-AodPONONet.yaml')  # build from YAML and transfer weights
        # Train the model
    results = model.train(data='coco128.yaml',epochs=100, imgsz=640, batch=8, device=0, workers=1, save=True,resume=False)
```

成功集成后，训练日志中将显示AodPONONet模块的初始化信息，表明已正确加载到模型中。
