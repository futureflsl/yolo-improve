...
> FL1623863129 已于 2025-05-27 13:59:45 修改 阅读量761 收藏 19 点赞数 17 公开
> 文章链接：https://blog.csdn.net/FL1623863129/article/details/148255417
...
<img src="./assets/19_1.png" alt="image-20240117154243631" style="max-height:745px; box-sizing:content-box;" />

ODConv中逐步将四种类型的注意力乘以卷积核的示意图。(a) 沿空间维度的位置逐个乘法操作，(b) 沿输入通道维度的通道逐个乘法操作，(c) 沿输出通道维度的滤波器逐个乘法操作，以及 (d) 沿卷积核空间的核维度的核逐个乘法操作。

<img src="./assets/19_2.png" alt="image-20240117154229110" style="max-height:547px; box-sizing:content-box;" />
...
<img src="./assets/19_3.png" alt="" style="max-height:306px; box-sizing:content-box;" />
...
- 支持的任务范围广泛：无论是对象检测、实例分割、图像分类、姿态估计还是定向对象检测 (OBB)，YOLO11 旨在应对各种计算机视觉挑战。
 ...
 <img src="./assets/19_4.png" alt="" style="max-height:270px; box-sizing:content-box;" />
...
##### 1. 新增ODConv.py实现模块（代码太多，核心模块源码请参考改进步骤.docx）然后在同级目录下面创建一个__init___.py文件写代码
...
    model = YOLO('yolo11-ODConv.yaml')  # build from YAML and transfer weights
        # Train the model
    results = model.train(data='coco128.yaml',epochs=100, imgsz=640, batch=8, device=0, workers=1, save=True,resume=False)
```

成功集成后，训练日志中将显示ODConv模块的初始化信息，表明已正确加载到模型中。

<div style="text-align:center;"><img alt="" src="https://i-blog.csdnimg.cn/direct/04e5b713677e443f88543b567f92130c.jpeg">​</div>
