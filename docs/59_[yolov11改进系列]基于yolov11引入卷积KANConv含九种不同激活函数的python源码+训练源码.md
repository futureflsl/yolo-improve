# [yolov11改进系列]基于yolov11引入卷积KANConv含九种不同激活函数的python源码+训练源码

> FL1623863129 于 2025-06-06 06:41:55 发布 阅读量916 收藏 19 点赞数 17 公开
> 文章链接：https://blog.csdn.net/FL1623863129/article/details/148462824

【KANConv介绍】

不同类型激活函数KANConv2d，包含：

KANConv2d：原始基于B 样条的 KAN 的卷积版本。
...
**Kolmogorov-Arnold Network（KAN）** 是一种受 [Kolmogorov–Arnold 表示定理](https://zhida.zhihu.com/search?content_id=255180557&content_type=Article&match_order=1&q=Kolmogorov%E2%80%93Arnold+%E8%A1%A8%E7%A4%BA%E5%AE%9A%E7%90%86&zhida_source=entity) 启发的新型神经网络架构。在 2024 年至 2025 年间，众多论文对 KAN 的理论进行了拓展，并在多个领域中应用 KAN 进行研究。以下是关于 KAN 相关研究论文的整理，包括其主要贡献和研究成果。

 <img src="./assets/59_1.png" alt="" style="max-height:621px; box-sizing:content-box;" />
...
KAN神经网络（Kolmogorov–Arnold Networks）是一种基于Kolmogorov-Arnold表示定理的新型神经网络架构。该定理指出，任何多元连续函数都可以表示为有限个单变量函数的组合。与传统多层感知机（MLP）不同，KAN通过可学习的激活函数和结构化网络设计，在函数逼近效率和可解释性上展现出潜力。
 ...
 <img src="./assets/59_2.png" alt="" style="max-height:529px; box-sizing:content-box;" />
...
<img src="./assets/59_3.png" alt="" style="max-height:306px; box-sizing:content-box;" />
...
- 支持的任务范围广泛：无论是对象检测、实例分割、图像分类、姿态估计还是定向对象检测 (OBB)，YOLO11 旨在应对各种计算机视觉挑战。
 ...
 <img src="./assets/59_4.png" alt="" style="max-height:270px; box-sizing:content-box;" />
...
<div style="text-align:center;">​<img alt="" src="https://i-blog.csdnimg.cn/direct/58a9813fe9774d1ba8f0545530be25f4.jpeg">​</div>
