...
> FL1623863129 于 2025-05-31 09:33:30 发布 阅读量691 收藏 15 点赞数 8 公开
> 文章链接：https://blog.csdn.net/FL1623863129/article/details/148349249
...
（3）我们提出一个Inception-like DBB结构实例(Fig 1)，并且展示它在ImageNet、COCO detection 和CityScapes任务中获得性能提升。
 ...
 <img src="./assets/37_1.png" alt="" style="max-height:679px; box-sizing:content-box;" />
...
DBB是基于六种变换模块而实现的，分别为：Conv-BN合并、并行合并、串行合并、并行拼接、平均池化变换和多尺度卷积合并。如下图：
 ...
 <img src="./assets/37_2.jpeg" alt="" style="max-height:515px; box-sizing:content-box;" />
...
<img src="./assets/37_3.png" alt="" style="max-height:306px; box-sizing:content-box;" />
...
- 支持的任务范围广泛：无论是对象检测、实例分割、图像分类、姿态估计还是定向对象检测 (OBB)，YOLO11 旨在应对各种计算机视觉挑战。
 ...
 <img src="./assets/37_4.png" alt="" style="max-height:270px; box-sizing:content-box;" />
...
##### 1. 新增DBB.py实现模块（代码太多，核心模块源码请参考改进步骤.docx）然后在同级目录下面创建一个__init___.py文件写代码
...
    model = YOLO('yolo11-DBB.yaml')  # build from YAML and transfer weights
        # Train the model
    results = model.train(data='coco128.yaml',epochs=100, imgsz=640, batch=8, device=0, workers=1, save=True,resume=False)
```

成功集成后，训练日志中将显示DBB模块的初始化信息，表明已正确加载到模型中。

<div style="text-align:center;">​<img alt="" src="https://i-blog.csdnimg.cn/direct/e057e16d9d8a472cb10afab9b5925153.jpeg"></div>
